            ...
            <div className="row">
                ...
                <div className="single-feature col-lg-4 col-md-6 col-12 mb-50">
                    ...
                    <div className="content fix">
                        ...
                        <p>Kidol is supper responsive &amp; work perfectly in all devices.</p>
                    </div>
                </div>
                <div className="single-feature col-lg-4 col-md-6 col-12 mb-50">
                    ...
                    <div className="content fix">
                        <h4>User Friendly</h4>
                        <p>Kidol easy to use for any technical &amp; nontechnical People.</p>
                    </div>
                </div>
                <div className="single-feature col-lg-4 col-md-6 col-12 mb-50">
                    ...
                    <div className="content fix">
                        <h4>Modern Design</h4>
                        <p>It comes with modern &amp; smart design layout.</p>
                    </div>
                </div>
                <div className="single-feature col-lg-4 col-md-6 col-12 mb-50">
